/* For a given list of digits 0 to 9, return a list with the 
same digits in the same order, but with all 0s paired. 
...
/*
- return the same digits
- pair all zeros
- keep first zero and remove second ones
*/
